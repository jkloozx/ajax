...
<h1 style="margin-top: 50px;color: silver">注册新用户</h1>
    <form method="post" action="register-server.php" class="re width" onsubmit="return r_submit()">
        <div class="lable">
            <input id="username" name="user" type="text" class="text" placeholder="用户名" onblur="check_username()">
            <span class="ab1" id="check_username"></span>
            <div class="clear"> </div>
            <input onblur="isEmail()" id="email" name="ema" placeholder="请输入您的电子邮箱" type="text" class="text">
            <span class="ab2" id="check_email"></span>
        </div>
        <div class="clear"> </div>
        <div class="lable-2">
