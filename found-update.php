...
<?php
if (isset($_COOKIE['isLogin']) && isset($_GET["updater"]) && isset($_GET["table"])) {
    require "mysql-connect.php";
    $updater = $_GET["updater"];
    $table = $_GET["table"];
    $sql = "select * from $table where id='$updater'";
    ...
    <div class="span9">
        ...
        <form action="found-update-server.php" method="post" id="edit-profile" class="form-horizontal">
            <fieldset style="color: wheat">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="title" type="text" class="input-xlarge" id="input01" value="<?php echo $row["title"];?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="input01">您的称呼</label>
                    <div class="controls">
                        <input name="chenghu" type="text" class="input-xlarge" id="input01" value="<?php echo $row["name"];?>"/>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="form-group">
                            <select name="wupin" style="color: black;background:rgba(108, 163, 255, 0.5);"
                                    class="form-control">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="email" type="text" class="input-xlarge" id="input01" value="<?php echo $row["email"];?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="input01">电话</label>
                    <div class="controls">
                        <input name="tel" type="text" class="input-xlarge" id="input01" value="<?php echo $row["tel"];?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="input01">联系地址</label>
                    <div class="controls">
                        <input name="address" type="text" class="input-xlarge" id="input01" value="<?php echo $row["address"];?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="input01">酬谢方式</label>
                    <div class="controls">
                        <input name="thanks" type="text" class="input-xlarge" id="input01" value="<?php echo $row["thanks"];?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="textarea">留言备注</label>
                    <div class="controls">
                        <textarea name="content" class="input-xlarge" id="textarea" rows="4"><?php echo $row["content"];?></textarea>
                    </div>
                </div>
                <div class="control-group">
