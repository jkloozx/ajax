...
$sql = "select * from lost where username='$username'";
$qry = mysql_query($sql);
...
$sql3 = "select id,title,wupin,place,address,email,tel,content,create_time  from lost where username='$username' order by id desc " . $page_obj->limit;
...
//mb_substr(,0,12,"utf-8");
    ...
    <td>
    <a href='lost-update.php?updater=$id2&table=lost'>
    <button type='button' class='btn btn-info btn-sm' '>
    修改
    </button>
    </a>
    <!-- Button trigger modal -->
<a href='delete.php?delete=$id2&table=lost'>
