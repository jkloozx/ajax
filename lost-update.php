...
if (isset($_COOKIE['isLogin']) && isset($_GET["updater"]) && isset($_GET["table"])) {
    ...
    <div class="span9">
        ...
        <form action="lost-update-server.php" method="post" id="edit-profile" class="form-horizontal">
            <fieldset style="color: wheat">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="place" type="text" class="input-xlarge" id="input01" value="<?php echo $row["place"];?>"/>
                    </div>
                </div>
                <div class="control-group">
